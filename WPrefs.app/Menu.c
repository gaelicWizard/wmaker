...
static void createPanel(_Panel * p)
{
...

	{
		...
		data->param.directory.directory =
		    "/usr/share/WindowMaker/Themes /usr/local/share/WindowMaker/Themes "DEF_DATA_PATH"/Themes";
		...
		data->param.directory.directory =
		    "/opt/kde2/share/wallpapers /usr/share/WindowMaker/Backgrounds "DEF_DATA_PATH"/Backgrounds";
		data->param.directory.stripExt = 1;
